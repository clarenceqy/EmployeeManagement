...
public class Controller implements Initializable {
    ...
    private ArrayList<Employee> cachedemployee;
    ...
    public void newEmployeeClicked(Employee employee) {
    ...
    public void clickonEmployee() {
        employeelistview.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                Employee clickedemployee = null;
                for (Employee e : cachedemployee) {
    ...
    public void addnewcom(){
        ...
        confirmbutton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                Company company = new Company(str,"1");
    ...
    public void initialEmployee(Employee employee) {
        for (int i = 0; i < 12; i++) {
            for (int j = 0; j < 31; j++) {
